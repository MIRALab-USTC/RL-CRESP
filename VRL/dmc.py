...
def make(name, frame_stack, action_repeat, seed, distracting_mode: str = None,
         background: bool = False, camera: bool = False, color: bool = False, num_videos: int = None,
         camera_scale: float = None, color_scale: float = None, background_dataset_videos: str = 'val'):
    pixel_hw = 84
    domain, task = name.split('_', 1)
    domain = dict(ball='ball_in_cup').get(domain, domain)
    task = dict(in_cup_catch='catch').get(task, task)
